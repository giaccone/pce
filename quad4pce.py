...
def growth_rule(level, kind='Legendre'):
    """
...
def smolyak_sparse_grid(polynom, level):
    """
    ...
    for k in range(o_min, o_max+1):
        multi_index, _ = index_with_sum(polynom.dim, k)
